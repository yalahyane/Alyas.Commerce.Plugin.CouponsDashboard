namespace Alyas.Commerce.Plugin.CouponsDashboard.Pipelines.Blocks
{
    ...
    public class GetPublicCouponsUsageViewBlock : GetListViewBlock
    {
        public GetPublicCouponsUsageViewBlock(CommerceCommander commerceCommander) : base(commerceCommander)
        {
        }
        public override async Task<EntityView> Run(EntityView arg, CommercePipelineExecutionContext context)
        {
            ...
            var entityView = new EntityView
            {
                ...
                ItemId = string.Empty,
                Name = context.GetPolicy<Policies.KnownCouponViewsPolicy>().PublicCouponUsage,
                DisplayName = "Public Coupons"
            };
            arg.ChildViews.Add(entityView);
            var listName = context.GetPolicy<Policies.KnownCouponsListsPolicy>().PublicCouponsList;
            await this.SetListMetadata(entityView, listName, context.GetPolicy<Policies.KnownCouponActionsPolicy>().PaginatePublicCoupons, context).ConfigureAwait(false);
